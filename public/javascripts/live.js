  ...
  var Live = {
    ...
    loadResources: function () {
      ...
      var scripts = document.getElementsByTagName("script"),
          ...
          resources = [];// Too heavy!!! GS [document.location.href];
...
//        }
        // Track only one CSS -- GS
        resources.push('http://localhost:3000/stylesheets/screen.css');

//      }
      // track local js urls //Too heavy!!! GS
