...
!function ($) {
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        var DRPTemplate = '<div class="daterangepicker dropdown-menu">' +
                ...
                '<div class="footer">' +
                    '<button class="btn btn-small" disabled="disabled">' + this.locale.cancelLabel + '</button>' +
                    '<button class="btn btn-small btn-primary" disabled="disabled">' + this.locale.applyLabel + '</button>' +
                '</div>' +
              '</div>';
