...
//        this.container = $(DRPTemplate).appendTo('body');
        this.container = $(DRPTemplate).appendTo('#sidebar');
    ...
    DateRangePicker.prototype = {
        ...
        move: function () {
            if (this.opens === 'left') {
                this.container.css({
                    ...
                    right: $(window).width() - this.element.position().left - this.element.outerWidth(),
                    left: 'auto'
                });
            } else {
                this.container.css({
        ...
        buildCalendar: function (month, year) {
            ...
            for (var j = 0, col = 0, row = 0; j < 42; j++, col++, curDate = curDate.clone().add(1).day()) {
                if (j > 0 && col % 7 === 0) {
                    col = 0;
                    row++;
                }
